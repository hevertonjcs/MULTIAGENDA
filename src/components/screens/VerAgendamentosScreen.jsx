...
import { ArrowLeft, Search, Trash2, Edit3, CalendarDays, User, FilterX, ListFilter } from 'lucide-react';
      ...
      <div className="screen-card-container">
        <div className="screen-header justify-between">
          <div className="flex items-center">
            ...
            <ListFilter className="w-6 h-6 sm:w-7 sm:h-7 text-brand-icon mr-2 sm:mr-3" />
            <div>
